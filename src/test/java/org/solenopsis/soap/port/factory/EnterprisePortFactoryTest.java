 ...
 * via the factory's get() method. Note: The createPort(service) method has a known issue
 * and is not tested.
 * </p>
 *
 * @author sfloess
...
class EnterprisePortFactoryTest {
     ...
     * This tests the working implementation that uses the CXF proxy factory correctly.
     */
    @Test
    void testGet() {
